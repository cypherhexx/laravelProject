...
class DashboardController extends Controller
{
    ...
    {        
        ...
        return view('customer_panel.home', compact('data','nameSpace'));
    }
    ...
    {   
        $nameSpace = "invoices";
        return view('customer_panel.invoices', compact('nameSpace'));   
    }

    function estimates()
    {
        $nameSpace = "estimates";
        return view('customer_panel.estimates', compact('nameSpace'));   
    }
    ...
    public function user_profile()
    {
        ...
        return view('customer_panel.profile', compact('nameSpace'))->with('rec', $rec);
    }
    ...
    {   
        ...
        $nameSpace = "statement";
        return view('customer_panel.statement', compact('data','nameSpace'))->with('rec', $records);
    }
